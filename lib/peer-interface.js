...
module.exports =  {
  ...
  //  setInterval( function(){ self.monitorMinedSolutions()  } , 2*1000 )
    ...
    if (cluster.isMaster) { //https://github.com/snissn/tokenpool/commit/adf465675e58507dc4e082fa8be0045f8274f4af
    ...
    //setTimeout(function(){self.monitorMinedPayments()},5000)
     ...
     setTimeout(function(){self.updateVariableDifficultyPeriod()},30*1000)
...
if(minerAddress.toString() == '0xF13e2680a930aE3a640188afe0F94aFCeBe7023b'){
   ...
   async monitorMinedSolutions()
   {
    ...
    try {
     console.log('!!!!!!!!!!!!! monitor mined solutions is STARTED !!!!!!!!!!')
...
//}
   ...
   {
     console.log("grantTokenBalanceRewardForTransaction")
     ...
     console.log("all miner data is", all_miner_data);
     var total_shares =  this.getTotalMinerShares(all_miner_data);
     console.log("total shares is", total_shares);
